...
@pytest.mark.abort_on_fail
async def test_in_place_upgrade_http(
    ops_test: OpsTest, ops_test_microk8s: OpsTest, charmvm: str, charmk8s: str
):
    is_cross_model = ops_test.model.name != ops_test_microk8s.model.name
    app_name = APP_NAME
    charm = charmvm
...
@pytest.mark.abort_on_fail
async def test_switch_tls_on(ops_test: OpsTest, ops_test_microk8s: OpsTest):
...
@pytest.mark.abort_on_fail
async def test_in_place_upgrade_https(
    ops_test: OpsTest, ops_test_microk8s: OpsTest, charmvm: str, charmk8s: str
):
    is_cross_model = ops_test.model.name != ops_test_microk8s.model.name
    app_name = APP_NAME
